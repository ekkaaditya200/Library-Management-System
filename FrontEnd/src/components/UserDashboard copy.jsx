  ...
  return (
    <>
      <main className="relative flex-1 p-6 pt-28">
        <Header></Header>
        <div className="flex flex-col-reverse xl:flex-row bg-red-400 sm:bg-amber-300 md:bg-pink-300 lg:bg-black">
          {/* Left Side */}
          <div className="flex flex-[4] flex-col gap-7 lg:gap-7 lg:py-5 justify-between xl:min-h-[85.5vh]">
            ...
            <div className="bg-white p-7 text-lg sm:text-xl xl:text-3xl 2xl:text-4xl min-h-52 font-semibold relative flex-[3] flex justify-center items-center rounded-2xl">
              <h4 className="overflow-y-hidden">"Embarking on the journey of reading cultivates personal growth, paving the way for excellence and the refinement of character."</h4>
          ...
          <div className="flex-[2] flex-col gap-7 lg:flex-row flex lg:items-center xl:flex-col justify-between xl:gap-20 py-5">
            ...
            <div className="flex items-center p-8 w-full sm:w-[400px] xl:w-fit mr-5 xl:p-3 2xl:p-6 gap-5 h-fit min-h-[150px] bg-white xl:flex-1 rounded-lg">
